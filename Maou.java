...
//     this.l = new JLabel[2];
//     this.l[0] = new JLabel("「まおうが現れた！」");
//     //JLabel maouaraware = new JLabel("「まおうが現れた！」");
//     this.l[0].setForeground(Color.white);
//     this.l[0].setFont(new Font("HGP創英角ﾎﾟｯﾌﾟ体",Font.PLAIN,24));
//     p.add(this.l[0]);
...
//     p3.setPreferredSize(footerPanelDimension);
// //どうする
//     this.l[1] = new JLabel("「どうする？」");
//     //JLabel dousuru = new JLabel("「どうする？」");
//     this.l[1].setForeground(Color.white);
//     //maouaraware.setFont(new Font("MS　ゴシック",Font.PLAIN,24));
//     p3.add(this.l[1]);
// //コマンド
//     this.b = new JButton[2];
//     this.b[0] = new JButton("攻撃");
//     //JButton kougeki  = new JButton("攻撃");
//     //kougeki.addActionListener(this);
//     this.b[1] = new JButton("逃げる");
//     //JButton nigeru = new JButton("逃げる");
